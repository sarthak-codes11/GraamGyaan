  ...
  return (
    ...
    >
      ...
      >
        ...
        {status === "ACTIVE" ? (
          <Link
            href={`/hindi/lesson?lesson=${encodeURIComponent(description)}`}
            className={[
                    ...
                    return (
                      ...
                      >
                        {tile.type === "fast-forward" && status === "LOCKED" ? (
                          <HoverLabel text="यहाँ कूदें?" textColor={unit.textColor} />
                        ) : selectedTile !== i && status === "ACTIVE" ? (
                          <HoverLabel text="शुरू करें" textColor={unit.textColor} />
                        ) : null}
                        <LessonCompletionSvg
                        ...
                        >
                          <TileIcon tileType={tile.type} status={status} />
                          <span className="sr-only">पाठ दिखाएँ</span>
                        </button>
                      </div>
                    );
                  case "treasure":
                    return (
                      <div
                        ...
                        aria-label={
                          status === "ACTIVE" ? "इनाम प्राप्त करें" : ""
                        }
                      >
                        {status === "ACTIVE" && (
                          <HoverLabel text="खोलें" textColor="text-yellow-400" />
                        )}
                        <TileIcon tileType={tile.type} status={status} />
                      </div>
                    );
...
const Learn: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className="flex justify-center gap-3 pt-14 sm:p-6 sm:pt-10 md:ml-24 lg:ml-64 lg:gap-12">
        <div className="flex max-w-2xl grow flex-col">
          ...
          <div className="sticky bottom-28 left-0 right-0 flex items-end justify-between">
            ...
            >
              <span className="sr-only">अभ्यास</span>
            ...
            {scrollY > 100 && (
              ...
              >
                <span className="sr-only">ऊपर जाएँ</span>
                <UpArrowSvg />
              </button>
            )}
          </div>
      ...
      {/* Tutor Chatbot */}
      <Chatbot pageId="hindi" locale="hi" docked />
    </>
  );
};
    ...
    >
      <header className="flex items-center justify-between gap-4 p-4">
        <div className="flex flex-col gap-1">
          <h2 className="text-2xl font-bold">इकाई {unitNumber}</h2>
